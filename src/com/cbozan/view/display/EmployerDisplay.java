...
public class EmployerDisplay extends JPanel implements Observer{
	...
	public EmployerDisplay() {
		...
		employerPaymentTotalLabel = new JLabel("Total 0 MGA");
	...
	public void updateJobTableData() {
		...
		if(selectedEmployer != null) {
			...
			jobCountLabel.setText(jobList.size() + " Employer");
		}
	...
	public void updateEmployerPaymentTableData() {
		...
		if(selectedEmployer != null) {
			...
			for(Invoice invoice : invoiceList) {
				...
				tableData[i][2] = invoice.getAmount() + " MGA";
			...
			employerPaymentTotalLabel.setText("Total " + totalAmount + " MGA");
